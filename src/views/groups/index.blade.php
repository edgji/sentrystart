...
@section('title')
@parent
{{trans('sentrystart::groups.groups')}}
@stop
		...
		<table class="table table-striped table-hover">
			...
			@foreach ($groups as $group)
				<tr>
					...
					<td>
						<button class="btn btn-default" onClick="location.href='{{ action('Edgji\Sentrystart\GroupController@edit', array($group->id)) }}'">{{trans('pages.actionedit')}}</button>
