...
@section('title')
@parent
{{trans('pages.actionedit')}} {{trans('sentrystart::groups.group')}}
@stop
...
<div class="row">
	...
	{{ Form::open(array('action' =>  array('Edgji\Sentrystart\GroupController@update', $group->id), 'method' => 'put')) }}
        <h2>{{trans('pages.actionedit')}} {{trans('sentrystart::groups.group')}}</h2>
